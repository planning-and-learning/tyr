...
void bind_ground_numeric_effect(nb::module_& m, RepositoryBinding& repository)
{
    ...
    ygg::bind_index<ygg::Index<GroundNumericEffect<Increase, AuxiliaryTag>>>(m, "AuxiliaryGroundNumericEffectIncreaseIndex");
    ...
    bind_ground_numeric_effect_view<Increase, AuxiliaryTag>(m, "AuxiliaryGroundNumericEffectIncrease");
    ...
    repository.def("get_or_create", &get_or_create_data<GroundNumericEffect<Increase, AuxiliaryTag>>, "data"_a, nb::keep_alive<0, 1>());
}
