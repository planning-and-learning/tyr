...
#ifndef PYTHON_SRC_PYTYR_FORMALISM_PLANNING_BINDING_UTILS_HPP_
#define PYTHON_SRC_PYTYR_FORMALISM_PLANNING_BINDING_UTILS_HPP_
...
{
    return ::tyr::formalism::planning::get_or_create(repository, data).first;
}
