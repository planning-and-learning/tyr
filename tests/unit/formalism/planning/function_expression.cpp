...
static_assert(FunctionExpressionContract<fp::FunctionExpression>);
static_assert(std::same_as<ygg::View<ygg::Data<fp::FunctionExpression>, fp::Repository>, fp::FunctionExpressionView>);
