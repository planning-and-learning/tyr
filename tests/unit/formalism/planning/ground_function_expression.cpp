...
static_assert(GroundFunctionExpressionContract<fp::GroundFunctionExpression>);
static_assert(std::same_as<ygg::View<ygg::Data<fp::GroundFunctionExpression>, fp::Repository>, fp::GroundFunctionExpressionView>);
