...
using Entity = fd::GroundConditionalEffect;
...
static_assert(std::same_as<View, fd::GroundConditionalEffectView>);
static_assert(std::constructible_from<Data, fd::GroundConjunctiveConditionView, fd::GroundConjunctiveEffectView>);
