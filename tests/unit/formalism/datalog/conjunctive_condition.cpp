...
using Entity = fd::ConjunctiveCondition;
...
static_assert(std::same_as<View, fd::ConjunctiveConditionView>);
static_assert(std::constructible_from<Data,
                                      fd::VariableViewList,
                                      fd::LiteralViewList<f::StaticTag>,
                                      fd::LiteralViewList<f::FluentTag>,
