...
using Entity = fd::GroundRule<tyr::formalism::PredicateTag>;
...
static_assert(std::same_as<View, fd::GroundRuleView<tyr::formalism::PredicateTag>>);
static_assert(std::constructible_from<Data,
                                      ...
                                      fd::GroundNumericEffectOperatorViewList<tyr::formalism::FluentTag>>);
