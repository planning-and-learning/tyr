...
void expect_repository_statistics(const SearchContext<Kind>& context, const planning::Statistics& statistics)
{
    ...
    EXPECT_EQ(statistics.get_action_bindings_memory_usage(), task_repository.template memory_usage<formalism::RelationBinding<formalism::planning::Action<LiftedTag>>>());
    ...
    EXPECT_EQ(statistics.get_axiom_bindings_memory_usage(), task_repository.template memory_usage<formalism::RelationBinding<formalism::planning::Axiom<LiftedTag>>>());
