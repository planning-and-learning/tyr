...
namespace
{
inline constexpr const char* kBottomUpFixture = "tests/fixtures/datalog/algorithms/lifted/bottom_up.json";
...
{
    const auto suite = ygg::common::load_json_file(ygg::common::root_path() / kBottomUpFixture);
