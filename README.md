...
- `pypddl >= 1.1, < 1.2` for Loki's PDDL parser library, headers, and CMake package.
...
```console
python -m pip install 'pyyggdrasil>=0.1,<0.2' 'pypddl>=1.1,<1.2' 'pypddl-datasets>=0.0.12,<0.1'
