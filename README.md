...
- `pyyggdrasil >= 0.2.5, < 0.3` for shared third-party native dependencies.
...
```console
python -m pip install 'pyyggdrasil>=0.2.5,<0.3' 'pypddl>=1.2.1,<1.3' 'pypddl-datasets>=0.0.12,<0.1'
