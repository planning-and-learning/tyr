...
static as::DepGraph build_dependency_graph(fp::TaskView<GroundTag> task, size_t num_atoms)
{
...
GroundAxiomStrata compute_ground_axiom_stratification(fp::TaskView<GroundTag> task)
{
