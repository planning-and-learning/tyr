...
template<>
struct AtomPackedStorage<GroundTag, TreeCompression> : ygg::comparison::Mixin<AtomPackedStorage<GroundTag, TreeCompression>>
{
    ygg::uint_t index;
...
class AtomStorageBackend<GroundTag, TreeCompression, ThreadSafe>
{
public:
