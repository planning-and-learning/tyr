...
class View<ygg::Index<::tyr::formalism::datalog::UnaryOperator<T>>, C>
{
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::datalog::UnaryOperator<T>> m_handle;

public:
    using OperatorType = ::tyr::formalism::ArithmeticOperatorKind;

    View(ygg::Index<::tyr::formalism::datalog::UnaryOperator<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
