...
auto make_view(const ygg::Data<::tyr::formalism::datalog::FunctionExpression<T>>& element, const C& context) noexcept
{
    return ygg::View<ygg::Data<::tyr::formalism::datalog::FunctionExpression<T>>, C>(element,
                                                                                     std::visit(
