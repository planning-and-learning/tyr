...
struct Index<tyr::formalism::datalog::GroundNumericEffect<T>> : ygg::IndexMixin<ygg::Index<tyr::formalism::datalog::GroundNumericEffect<T>>>
{
    ...
    using Base = ygg::IndexMixin<ygg::Index<tyr::formalism::datalog::GroundNumericEffect<T>>>;
    using Base::Base;
};
