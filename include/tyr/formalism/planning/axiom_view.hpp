...
class View<ygg::Index<::tyr::formalism::planning::Axiom<T>>, C>
{
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::planning::Axiom<T>> m_handle;

public:
    View(ygg::Index<::tyr::formalism::planning::Axiom<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
