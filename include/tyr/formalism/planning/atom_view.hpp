...
class View<ygg::Index<::tyr::formalism::planning::Atom<T, F>>, C>
{
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::planning::Atom<T, F>> m_handle;

public:
    View(ygg::Index<::tyr::formalism::planning::Atom<T, F>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
    ...
    auto get_predicate() const noexcept
    {
        ...
        {
            return ygg::make_view(get_data().predicate, *m_context);
        }
    }
