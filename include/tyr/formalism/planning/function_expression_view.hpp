...
class View<ygg::Data<::tyr::formalism::planning::FunctionExpression<T>>, C>
{
private:
    const C* m_context;
    ygg::Data<::tyr::formalism::planning::FunctionExpression<T>> m_handle;

public:
    View(ygg::Data<::tyr::formalism::planning::FunctionExpression<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
