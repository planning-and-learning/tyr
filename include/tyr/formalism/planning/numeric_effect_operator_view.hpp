...
auto make_view(const ygg::Data<::tyr::formalism::planning::NumericEffectOperator<T, F>>& element, const C& context) noexcept
{
    return ygg::View<ygg::Data<::tyr::formalism::planning::NumericEffectOperator<T, F>>, C>(
        element,
