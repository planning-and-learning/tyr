...
PLANNER_DIR = REPO / "build-delta-kpkc-inner" / "exe" / "gbfs_lazy"
...
for SUITE in SUITES:
    for domain in pypddl_datasets.fetch_suite(SUITE).domains:
        for task in domain.tasks:
            ...
            run.set_property("algorithm", f"gbfs-lazy-delta-kckp-hff-pref-ff-{NUM_THREADS}")
            ...
            # multiple algorithms.
            run.set_property("id", [f"gbfs-lazy-delta-kckp-hff-pref-ff-{NUM_THREADS}", task.domain, task.problem])
